...
<div class="card">
    <div class="card-header">
        <div class="row">
            <div lass="col-md-9">Teacher List</div>
...
<div class="card-body">
    <div class="table-responsive">
        <span id="message-operation"></span>
...
<div class="form-group">
    <div class="row">
        ...
        <div class="col-md-8">
            <textarea name="teacher_address" id="teacher_address" class="form-control">
</textarea>
...
<div class="modal_footer">
    ...
    <input type="hidden" name="teacher_id" id="teahcer_id"/>
...
<div class="modal" id="deleteModal">
    <div class="modal-dialog">
        ...
        <div class="modal-header">
            <ha class="modal-title">Delete Confirmation</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
</div>
...
$('#teacher_form').on('submit', function(event){
    ...
    $.ajax({
        url:"teacher_action.php",
        method:"POST",
        data: new FormData(this).append("teacher_id",teacher_id),
        dataType:"json",
        contentType:false,
        processData:false,
        beforeSend:function()
...
if(data.error)
{
    ...
    {
        $('#error_teacher_emailid').text(data.error_teahcer_emailid);
    }
    else{
        $('#error_teacher_emailid').text('');
    }
    ...
    {
        $('#error_teacher_password').text(data.error_teahcer_password);
    }
    else{
        $('#error_teacher_password').text('');
    }
    ...
    {
        $('#error_teacher_qualification').text(data.error_teahcer_qualification);
    }
    else{
        $('#error_teacher_qualification').text('');
    }
        ...
        success:function(data)
{
  ...
  $('#ok_button').click(function(){
    $.ajax({
        ...
        method:"POST",
        data:{
            teacher_id:teacher_id, action :'delete'},
            success:function(data)
            {
                $('#message_operation').html('<div class="alert alert-success">' +data+' </div>');
                $('#deleteModal').modal('hide');
